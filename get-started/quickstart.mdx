---
title: "Quickstart"
description: "Get a key, point your client at the Hopscotch base URL, and send your first chat completion."
status: partial
gates: ["2.3", "2.10", "2.11"]
---
...
<Steps>
  <Step title="A verified account">
    Sign up and verify your email address at [platform.hopscotchlabs.ai](https://platform.hopscotchlabs.ai).
  </Step>
  <Step title="A workspace with credit">
    Credit is prepaid, so a workspace with a zero balance refuses requests
    before they reach a provider. The workspace owner or an admin buys credit on the Billing
    screen. See [buying credit](/manage/buy-credit).
  </Step>
...
for a non-streamed request are in [Activity](/manage/monitor-usage) rather than
...
[Streaming](/features/streaming) covers the usage line's fields and what happens
