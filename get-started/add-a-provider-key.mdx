...
Provider keys are managed in the dashboard, at [BYOK](https://platform.hopscotchlabs.ai),
...
[Bring your own key](/features/bring-your-own-key) first.
...
[Workspaces and members](/manage/workspaces-and-members) for the full role
table.
...
<CardGroup cols={2}>
  <Card title="Bring your own key" href="/features/bring-your-own-key">
