...
The figure in force is shown on the Limits tab in Settings.
...
The Limits tab in Settings lists your limits one unit at a time, and marks each one
as yours or shared. The distinction is the rule, not a label:
