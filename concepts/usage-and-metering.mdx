...
status: partial
gates: ["5.3", "5.4", "5.11", "5.12", "5.13", "5.14"]
---
...
the Overview and Activity screens read, what your totals are summed from, and what a
...
<FeatureStatus>
  Epic 5's usage screens and endpoints are at review. The field set, the outcome
  vocabulary and the retention window above are the shipped behaviour; the shape of
  the summary responses may still gain fields before this page is published.
</FeatureStatus>
...
<CardGroup cols={2}>
  <Card title="Monitor usage" href="/guides/monitor-usage">
    Reading Overview and Activity, filtering, and looking up one request.
  </Card>
