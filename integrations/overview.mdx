...
<CardGroup cols={2}>
  <Card title="OpenAI SDK for Python" icon="python" href="/integrations/openai-sdk-python">
    The reference case. Two constructor arguments.
  </Card>
  <Card title="OpenAI SDK for Node" icon="node-js" href="/integrations/openai-sdk-node">
