---
title: "Vercel AI SDK"
description: "Which of the AI SDK's two OpenAI providers to use with Uniblock, and why its default call shape is the wrong one for this API."
status: partial
gates: ["2.3", "2.11"]
---
...
const uniblock = createOpenAICompatible({
  name: "uniblock",
...
const { text } = await generateText({
  model: uniblock("openai/gpt-4o-mini"),
