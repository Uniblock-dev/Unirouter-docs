...
description: "Point the official openai npm package at Hopscotch with two constructor options, and the one browser setting to leave switched off."
status: partial
gates: ["2.3", "2.11"]
---
...
[Streaming](/features/streaming) documents the line.
