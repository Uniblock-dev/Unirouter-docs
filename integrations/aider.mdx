---
title: "Aider"
description: "Point Aider at Uniblock: the base URL flag, the three models it configures separately, and how its provider prefix collides with a pinned id."
status: partial
gates: ["2.3", "2.11"]
---
...
```bash
export OPENAI_API_BASE=https://ai.uniblock.dev/v1
...
back `404` with `unknown_url`, print the path Aider is calling before assuming
