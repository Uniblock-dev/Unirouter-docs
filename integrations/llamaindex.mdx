---
title: "LlamaIndex"
description: "Use LlamaIndex's OpenAILike class with Uniblock, why the plain OpenAI class refuses our model ids before sending, and what to do about embeddings."
status: partial
gates: ["2.3", "2.11"]
---
...
llm = OpenAILike(
    ...
    api_base="https://ai.uniblock.dev/v1",
