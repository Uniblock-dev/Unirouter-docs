...
<FeatureStatus>
  The Statement screen is built and awaiting its final design approval. The endpoint
  behind it, its page size and its purchase annotation are shipped.
</FeatureStatus>
...
<FeatureStatus>
  The saved card flow is built and at review. It has been exercised in test mode and
  not yet against production, so treat this section as the intended behaviour and
  check the screen.
</FeatureStatus>
