...
purchase and never taken when a request is served. Currently 0%, our opening
promotion. The rate that applies to a purchase is fixed when checkout starts. See
