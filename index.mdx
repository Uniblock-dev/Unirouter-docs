...
currently 0%, so buying 100 credits charges 100.00 and grants 100 credits, all
100 of which are spendable. The rate that applies to a purchase is fixed when
you start checkout.
...
[dashboard](https://platform.hopscotchlabs.ai) instead of a page that would go stale.
