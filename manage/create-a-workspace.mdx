...
[Create an API key](/get-started/create-an-api-key) and
[Invite and manage members](/manage/invite-and-manage-members).

Being the owner is what lets you buy credit for it in the first place: only the
owner or an admin can buy credit or manage the card, and only the owner can pause
requests. See
[the owner and money](/manage/workspaces-and-members#the-owner-and-money).
