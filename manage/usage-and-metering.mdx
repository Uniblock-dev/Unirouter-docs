...
description: "What Hopscotch records for every request, what it never records, when the figures appear, and how long they are kept."
status: partial
gates: ["5.4", "5.11", "5.12", "18.62"]
---
...
See [Bring your own key](/features/bring-your-own-key) for what changes, and what
...
[Data and privacy](/manage/data-and-privacy) for the full data stance.
