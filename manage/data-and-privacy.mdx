...
description: "What Hopscotch records about a request, what it does not record, how long records are kept, and what we cannot recover for you."
status: write-now
gates: ["5.7", "5.8"]
---
...
See also [Security](/manage/security) for the promises that are about
