...
you to do. The refusal carries `Retry-After` in whole seconds.

Read [Rate limits and spend controls](/manage/rate-limits-and-spend-controls) first
...
- **Lowering always works.** If your cap is above the self service ceiling, you can
  still lower it to any figure at or above 1 minor unit. You just cannot raise it
