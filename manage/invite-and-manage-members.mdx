...
Members are managed in the dashboard, at [Team](https://platform.hopscotchlabs.ai). This
...
[Create an API key](/get-started/create-an-api-key#keys-that-arrive-with-an-invitation).
...
requests. Read [the owner and money](/manage/workspaces-and-members#the-owner-and-money)
before you press it.
...
<CardGroup cols={2}>
  <Card title="Workspaces and members" href="/manage/workspaces-and-members">
