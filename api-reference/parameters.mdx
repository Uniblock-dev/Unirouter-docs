...
Neither read changes the field. A value this cannot make sense of falls back to
being treated as absent rather than being corrected, and the provider answers
for its own body.
