...
trace**. See [Usage and metering](/manage/usage-and-metering) for the full
...
[Models](/features/models) for how the callable set is decided and discovered.
...
same screen. See
[Add a provider key](/get-started/add-a-provider-key) for how to replace it, and
[Errors and refusals](/features/errors) for how a response like this is
shaped.
...
provider keys. See [Workspaces and members](/manage/workspaces-and-members)
for the full role table.

## Next

<CardGroup cols={2}>
  <Card title="Add a provider key" href="/get-started/add-a-provider-key">
